...
using var pen = new UinputOutput(width, height, ReMarkable2Profile.Instance.Pen);
...
pen.Send(new MappedFrame(400, 300, 0, 0, 0, false, false, false, true));
pen.Send(new MappedFrame(420, 320, 512, 10, -10, true, false, false, true));
pen.Send(new MappedFrame(420, 320, 0, 10, -10, false, false, false, true));
pen.Send(new MappedFrame(0, 0, 0, 0, 0, false, false, false, false));

touch.Send(new MappedTouchFrame([
    new MappedTouchContact(0, 100, 500, 400, 500),
    new MappedTouchContact(1, 101, 900, 400, 500)
]));
touch.Send(new MappedTouchFrame([
    new MappedTouchContact(0, 100, 520, 420, 500),
    new MappedTouchContact(1, 101, 920, 420, 500)
]));
touch.ReleaseAll();
